import styles from "./MySunglasses.module.css";
function MySunglasses({data}) {
  return (
    <svg
      ...
      <path
        ...
        d="M490.667,234.667h-2.136c-9.884-48.686-52.929-85.333-104.531-85.333c-37.953,0-71.274,19.828-90.18,49.686
